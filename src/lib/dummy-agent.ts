    ...
    const agent = await createAgent({
        ...
        systemPrompt: new SystemMessage(
            [
                ...
                ...minimumTargetLines,
                "Hard constraints:",
                "- IMPORTANT: Always double-quote camelCase column names, e.g. \"customerId\", \"tagId\", \"productId\", \"totalPrice\", \"soldAt\", \"favoriteProductId\", \"createdAt\", \"updatedAt\", \"promoWeekId\", \"weekStart\", \"promoIdeaId\".",
