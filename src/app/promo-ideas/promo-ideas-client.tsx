...
export function PromoIdeasClient({
  ...
  const generatedByName = weeksMap.get(activeWeek)?.generatedByName;
  const generatedByEmail = weeksMap.get(activeWeek)?.generatedByEmail;
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="recommended" className="space-y-4">
          ...
          <div className="rounded-base border-2 border-border bg-background px-3 py-2 text-sm font-base">
            Generated by: {generatedByName ?? generatedByEmail ?? "Unknown"}
          </div>
